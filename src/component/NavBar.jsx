            ...
            <div className="flex justify-between items-center p-4 backdrop-blur-3xl  w-full">
                ...
                <div className={`hidden lg:flex lg:gap-3`}>
                    ...
                    {({ isActive }) => (
                     ...
                     theme={theme}
                     text="Home"
                      className={isActive ? "bg-[#ffd166] text-black" : ""} />
                     )}
                    </NavLink>
                ...
                <div className="text-xl flex items-center gap-5">
                    ...
                    <label className="swap swap-rotate">
                        ...
                        {/* moon icon */}
                        <svg
                            className="swap-off h-10 w-10 fill-current  text-black hover:text-yellow-300"
                        ...
                        {/* sun icon */}
                        <svg
                            className="swap-on h-10 w-10 fill-current text-white hover:text-blue-400"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                        >
